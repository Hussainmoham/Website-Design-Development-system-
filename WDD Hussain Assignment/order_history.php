...
// If user_id is not in session, try to get it from username
if (!$user_id && $username) {
...
// If still no user_id, try customers table
if (!$user_id) {
    if ($username) {
...
<head>
    ...
    <title>Order History - Premium Tool</title>
...
<body>
    ...
    <div class="order-history-layout">
        ...
        <section class="order-history-header">
            <div class="container">
                <h1>Order History</h1>
                <p style="color: rgba(255, 255, 255, 0.9); position: relative; z-index: 1;">View all your past orders and track their status</p>
            </div>
        </section>
